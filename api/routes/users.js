...
/*router.get('/:loginbyid', (req, res, next) => {

    const functionName = "fleetmanager.fn_users_getbyid"+"("+req.params.userId+")";
...
router.put('/update', (req, res, next) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        const updateQuery = `cardealership.fn_update_make`;
        ...
        client.connect().then(() => {
            ...
            client.query(sql, paramsvalues)
                .then((results) => {
                    ...
                    console.log('update make error:', error);
                    res.status(500).json({
                        message: 'update Makes Error',
                        data: error
                    });
                    client.end();
                    reject(error);
